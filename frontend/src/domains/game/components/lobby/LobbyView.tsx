...
import { ShopScreen } from "@/domains/user/components/shops/ShopView";
import InventoryScreen from "@/domains/user/components/items/InventoryView";
import { AchievementsScreen } from "@/domains/user/components/achievements/AchievementsView";
import FriendsScreen from "@/domains/user/components/friends/FriendsView";
import { SettingsScreen } from "@/domains/user/components/profile/SettingsView";
import { GameGuideScreen } from "@/domains/game/components/game/GameGuideScreen";
import { CharacterViewer } from "@/domains/user/components/CharacterViewer";
...
export function LobbyScreen({ onStartGame }: LobbyScreenProps) {
  ...
  const WebcamArea = useMemo(
    ...
    [videoRef, isWebcamEnabled, isMicEnabled, isConnecting, connectionStatus, error, toggleWebcam, toggleMic, setIsWebcamModalOpen, isVideoEnabled]
  );
