...
//         {/* 참가자 그리드 */}
//         {/* <div className="w-64 bg-white/50 backdrop-blur-sm border-r border-orange-200 p-4 flex flex-col">
//           <h3 className="text-lg font-semibold text-orange-800 mb-4 flex-shrink-0">참가자</h3>
//           <div className="flex-1 flex flex-col gap-3 justify-around">
//             {participants.slice(0, 5).map((participant, index) => (
//               <div key={participant?.id || index} className="bg-white/70 rounded-lg p-3 border border-orange-200">
//                 <div className="w-full h-20 bg-orange-200 rounded mb-2 flex items-center justify-center">
//                   <span className="text-orange-600 text-sm">{participant?.name || `참가자 ${index + 1}`}</span>
//                 </div>
//                 <div className="text-center">
//                   <div className="text-sm font-medium text-orange-800">{participant?.name || `참가자 ${index + 1}`}</div>
//                   <div className="text-xs text-orange-600">그리는 중...</div>
//                 </div>
//               </div>
//             ))}
//           </div>
